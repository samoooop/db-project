...
where s.mid=? and s.sid = tl.l_sid and tl.until > DATE_ADD(current_date(), INTERVAL 543 year) and tl.since < DATE_ADD(current_date(), INTERVAL 543 year)
;
